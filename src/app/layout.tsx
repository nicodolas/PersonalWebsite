...
export const metadata: Metadata = {
  title: "Nguyễn Văn Hiếu | Developer",
  description: "Portfolio of Nguyen Van Hieu (nicodolas/nicoleon) - A Developer specializing in MERN stack, performance optimization and scalable web applications. See my projects and CV.",
  keywords: [
    "nekovibecoder",
    "Nguyen Van Hieu",
    "Nguyễn Văn Hiếu",
